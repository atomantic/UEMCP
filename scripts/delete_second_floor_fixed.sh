#!/bin/bash
# Delete all second floor assets using curl - fixed version

BASE_URL="http://localhost:8765"

echo "Finding and deleting all second floor assets..."

# Find all second floor actors - fixed version

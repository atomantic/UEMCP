...
describe('tool-registry', () => {
  ...
  describe('TypeScript type definitions', () => {
    ...
    it('should provide ToolCategory type that includes all categories', () => {
      const testCategory: ToolCategory = 'system';
  ...
  describe('registry completeness', () => {
    ...
    it('should maintain consistency with expected MCP tool count', () => {
      // According to our current implementation, we should have 43 tools
  ...
  describe('const assertions', () => {
    it('should maintain readonly arrays', () => {
      ...
      // These should be stable numbers (updated for current tool count)
      expect(toolCount).toBe(43);

...
NO_COLLISION_RESPONSE = {
    ...
    "sockets": [],
    "materialSlots": [
        {"slotName": "Default", "materialPath": None}
    ],
    "numVertices": 8,
    "numTriangles": 12,
    "numLODs": 1
...
ASSET_LOAD_ERROR = {
    "success": False, 
    "error": "Failed to load asset: Asset class is not StaticMesh"
}

PERMISSION_ERROR = {
    "success": False,
    "error": "Access denied: Cannot read asset in protected folder"
}

# Edge case responses
MINIMAL_ASSET_RESPONSE = {
    "success": True,
    "assetType": "StaticMesh"
}

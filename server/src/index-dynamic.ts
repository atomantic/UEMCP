...
async function main(): Promise<void> {
  try {
    ...
    // Initialize server manager with the appropriate registry
    // Note: ServerManager needs to be updated to accept HybridToolRegistry
    // eslint-disable-next-line @typescript-eslint/no-explicit-any, @typescript-eslint/no-unsafe-argument
    const serverManager = new ServerManager(toolRegistry as any, configManager);

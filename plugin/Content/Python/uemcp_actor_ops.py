...
class ActorOperations:
    ...
    def spawn(self, assetPath, location=[0, 0, 100], rotation=[0, 0, 0], 
        ...
        try:
            ...
            if validate:
                from uemcp_validation import validate_actor_spawn
    ...
    def delete(self, actorName, validate=True):
        ...
        try:
            ...
            # Add validation if requested
            if validate:
                from uemcp_validation import validate_actor_deleted
    ...
    def modify(self, actorName, location=None, rotation=None, scale=None, 
        ...
        try:
            ...
            # Add validation if requested
            if validate:
                from uemcp_validation import validate_actor_modifications
                modifications = {}
                if location is not None:

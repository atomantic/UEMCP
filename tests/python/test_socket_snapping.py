...
class SocketSnappingUnitTest:
    ...
    def create_test_actor_with_socket(self, name: str, location: Tuple[float, float, float], 
                                     socket_name: str, socket_offset: Tuple[float, float, float]) -> unreal.Actor:
    ...
    def test_basic_socket_math(self):
        ...
        actual_location = [
            socket_transform.location.x,
            socket_transform.location.y,
            socket_transform.location.z
        ]
        
        self.assert_equal(actual_location, expected_location, tolerance=0.01, 
                         message="Socket world position")
    ...
    def test_rotated_socket_math(self):
        ...
        self.assert_equal(actual_location, expected_location, tolerance=1.0,
                         message="Rotated socket world position")
    ...
    def test_socket_to_socket_alignment(self):
        ...
        self.assert_equal(distance, 0, tolerance=1.0,
                         message="Socket alignment distance")
    ...
    def test_socket_with_offset(self):
        ...
        self.assert_equal(actual_z, expected_z, tolerance=1.0,
                         message="Socket with offset Z position")
